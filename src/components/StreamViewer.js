...
// Get signaling server URL from environment variable or fallback to localhost
    ...
    try {
      ...
      if (turnServer) {
        iceServers.push({
          ...
          username: process.env.REACT_APP_TURN_USERNAME || 'dome',
          credential: process.env.REACT_APP_TURN_PASSWORD || 'domepass123'
        });
      }
